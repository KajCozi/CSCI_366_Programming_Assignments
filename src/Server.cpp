...
// <fstream>> is included in Server.hpp
#include "common.hpp"
#include "Server.hpp"


// Current challenge: Proccess shot - for some reason the difference between the files is 10? WHYYYY
...
// Define the char arrays for the player's boards
// Both are a 10x10 matrix of chars
...
int get_file_length(ifstream *file){
    ...
    //Use this for the OUT_OF_BOUNDS in evaluate shot???
    // Couldn't figure out how to use this function
